...
#define LED_PIN D1  // LED eksternal terhubung ke D1 (GPIO5)
...
void setup() {
  ...
  pinMode(LED_PIN, OUTPUT); // Setup pin LED
  digitalWrite(LED_PIN, LOW); // LED mati awalnya
...
void loop() {
  ...
  // --- Kontrol LED: nyalakan sebentar sebagai indikator pembacaan sukses ---
  digitalWrite(LED_PIN, HIGH);   // LED ON
  delay(200);                    // nyala 200 ms (ubah sesuai selera)
  ...
  delay(300); // kecilkan bounce / multiple reads (opsional)
}
